...
# Function to process and insert time data
...
with DAG(
    ...
    # Define additional PythonOperator tasks for other insert functions here
...
[insert_source, insert_time, insert_news_detail, insert_sentiment, insert_type] >>  insert_fact_news
    # Additional dependencies for other tasks should be defined here